...
Створено публічний маршрут GET /bookings/schedule, який повертає лише час зайнятих кімнат. Фронтенд перевіряє ці дані перед відправкою форми, миттєво блокуючи спроби забронювати зайнятий час.
